...
html_temp = """
<div class="header">
    <h1 style="color:white;">UH CO2 Solubility in Brine Calculator</h1>
</div><br>"""
...
st.subheader("Product Description - Calculates the CO2 Solubility in Brine for Different 9 Salts type at specific Pressure and Temperature.")
...
if file is not None:
    ...
    if st.button('Download Results', key='download_button'):
